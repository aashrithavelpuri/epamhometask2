...
public class Newyeargiftbox 
{
    ...
    { 
        int total_weight = 0,quantity = 0,weight = 0,total_box_wt = 0,total_candies = 0;
        char n1;
        Sweets collect;
        Boolean n=true;
        Scanner sc=new Scanner(System.in);
        while(n) {
        System.out.println("AVAILABLE SWEETS FOR NEW YEAR GIFT BOX");
        ...
        try {
        	...
        	case '1':
        	   ...
        	   total_box_wt=total_box_wt+total_weight;
        	   System.out.println("Total weight of Darkchocolate is:"+total_weight+" grams");
        	   System.out.println("Total weight of gift box is:"+total_box_wt+" grams");
        ...
        case '2':
        	   ...
        	   n1=sc.next().charAt(0);
        	      if(n1=='y'|| n1=='Y')
        		    ...
        		    {
        	    	  n=false;
        	          System.out.println("Toatal gift box weight is:"+total_box_wt+" grams");
        	          System.out.println("Total number of candies in the giftbox is:"+total_candies);
        	          break;
        	        }
        case '3':
        ...
        case '6':
        	...
        	break;}
        		...
        		System.out.println("Total number of candies in the giftbox is:"+total_candies);
        	break;}
        default:System.out.println("Please select only from 1-6 options");
